...
namespace MVCBase.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl, string cod)
        {
            ...
            if (cod != null)
            {
                var encriptado = CShrapEncryption.DecryptString(cod, "31");
        ...
        public ActionResult Unlog()
        {
           ...
           // Verificar si el cookie de sesión del padre está presente en la solicitud
           if (httpContext.Request.Cookies["sisAccWeb"] != null)
           {
               // Redireccionar al login del padre
               return Redirect("http://192.168.144.4:82/Home/Index");
           }
           if (httpContext.Request.Cookies["sisAccWeb"] == null)
           {
               // Redireccionar al login del padre
               return Redirect("http://192.168.144.4:82/Account/Login");
           }
           // Si el cookie de sesión del padre no está activo, redireccionar al login del usuario actual
           return Redirect("http://192.168.144.4:82/Account/Login");
        ...
        [HttpGet]
        [AllowAnonymous]
        public ActionResult LogoutAndClose()
        {
            return View();
        }
