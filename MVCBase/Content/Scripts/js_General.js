    ...
    $.blockUI({
        ...
        message: `
            <div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img src="/Content/images/loading.gif" alt="Cargando..." style="margin-bottom: 10px;">
                <span style="color: white; font-size: 16px;">Cargando proceso...</span>
            </div>`,
        css: {
            border: 'none',
...
function AlertMessage(content) {
    ...
    } else if (window.DevExpress) {
        DevExpress.ui.dialog.alert(content, "Mensaje");
    } else {
        alert("Biblioteca no disponible");
    }
}
